...
//        func convertRomanToArab(var numerical:String)->Int {
//            if ((numerical as NSString).length > 0 || numerical != "") {
//               numerical = numerical.uppercaseString
//                for(var i=0;i<numericals.count;i++){
//                    let pos = numerical.characters.indexOf(num[i])
//                    print(pos)
//                }
//                
//                    return 0
